 ...
 */
/**
 * @file    TwiMasterConstants.h
 * @brief   Nil RTOS Two Wire Interface constants.
 *
 * @defgroup twoWire NilTwi
 * @details Nil RTOS Two Wire Interface library.
 * @{
 */
#ifndef TwiMasterConstants_h
#define TwiMasterConstants_h
#include <inttypes.h>
